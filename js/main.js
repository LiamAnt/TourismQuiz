$(document).ready(function () {
  ...
  $('.primaryBtn').hover(function() {
    $(this).find('img').attr('src', 'TourismQuiz/images/arrow_icon_hover.svg');
  }, function() {
    $(this).find('img').attr('src', 'TourismQuiz/images/arrow_icon.svg');
  });

  $('.primaryBtn.result_btnRefresh').hover(function() {
    $(this).find('img').attr('src', 'TourismQuiz/images/refresh_icon_hover.svg');
  }, function() {
    $(this).find('img').attr('src', 'TourismQuiz/images/refresh_icon.svg');
  });
